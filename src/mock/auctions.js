export const mockAuctions = [
  {
    ...
    currentPrice: 8500,
    auctionDate: new Date(Date.now() + 1000 * 60 * 60 * 2).toISOString(), // Live auction in 2 hours
    ...
    category: "Watches",
    bids: 12,
    location: "Central Bank Repository - Hall A",
  },
  {
    id: 2,
    ...
    currentPrice: 1200,
    auctionDate: new Date(Date.now() - 1000 * 60 * 30).toISOString(), // Started 30 mins ago - LIVE NOW
    status: 'live',
    image: "https://images.unsplash.com/photo-1544531585-9847b68c8c86?q=80&w=800&auto=format&fit=crop",
    category: "Art",
    bids: 8,
    location: "Central Bank Repository - Hall B",
  },
  {
    id: 3,
    ...
    currentPrice: 155000,
    auctionDate: new Date(Date.now() + 1000 * 60 * 60 * 24).toISOString(), // Tomorrow
    status: 'scheduled',
    image: "https://images.unsplash.com/photo-1584345604476-8ec5e12e42dd?q=80&w=800&auto=format&fit=crop",
    category: "Automobiles",
    bids: 45,
    location: "Central Bank Repository - Main Hall",
  },
  {
    id: 4,
    ...
    currentPrice: 4200,
    auctionDate: new Date(Date.now() - 1000 * 60 * 60 * 3).toISOString(), // 3 hours ago - completed
    status: 'completed',
    image: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?q=80&w=800&auto=format&fit=crop",
    category: "Electronics",
    bids: 23,
    location: "Central Bank Repository - Hall C",
  }
];
